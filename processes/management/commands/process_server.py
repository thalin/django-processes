...
class Command(BaseCommand):
    ...
    def parse_options(self, *args, **kwargs):
        ...
        if options['pidfile'] is not None:
            ...
            pidfile.write("%d\n" % getpid())
            pidfile.close()
        max_processes = getattr(settings, "MAX_PROCESSES", 4) # default to 2
    ...
    def handle(self, *args, **kwargs):
        ...
        try:
            ...
            while(True):
                ...
                to_run = max_processes - processing # Figure out how many new processes to run
                ...
                if to_run > 0:
                    ...
                    for pclass in subclasses: # Build process queue
                        processes.extend([procs for procs in pclass.objects.filter(completed=False,error=False,processing=False)])
